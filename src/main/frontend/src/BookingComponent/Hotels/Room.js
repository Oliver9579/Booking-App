...
import {faCity, faEuroSign, faPerson, faWifi} from "@fortawesome/free-solid-svg-icons";
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
import "./BookingRooms.css";

const Room = ({room, searchData, onRoomCountChange}) => {
    ...
    return (
        <div className="col-10 cols row" style={{padding: 0, textAlign: "center"}}>
            <div className="col-3 room-data" style={{textAlign: "left", padding: 0}}>
                ...
                <p style={{margin: '5% 5% 5%'}}> City view <FontAwesomeIcon icon={faCity}/></p>
                <p style={{margin: '5% 5% 5%'}}> Free WiFi <FontAwesomeIcon icon={faWifi}/></p>
            </div>
            <div className="col-3 room-data" style={{padding: 0}}>
                <p style={{margin: '10%'}}><FontAwesomeIcon icon={faPerson}/> X {room.capacity}</p>
            </div>
            <div className="col-3 room-data">
