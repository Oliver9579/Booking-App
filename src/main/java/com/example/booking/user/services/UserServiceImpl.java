...
public class UserServiceImpl implements UserService {
  ...
  public UserDTO deleteUser(User user) {
    List<BookedCar> bookedCars = carService.getBookedCarsWithUnavailableDays(user);
    carService.updateCarAvailability(bookedCars);
    List<BookedRoom> bookedRooms = roomService.getBookedRoomsWithUnavailableDays(user);
    roomService.updateRoomAvailability(bookedRooms);
    seatService.updateSeatsAvailability(user);
